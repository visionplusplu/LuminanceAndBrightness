function DisplayComparison(corrRGB,caliPath,oled_weights,cubeRGBs4Fitting,OptimalSumWeight,OptimalMaxWeight,AllSub_Name,FigId1,FigId2,FigId3)
...
%% Plot Gamut
figure("Name",FigId1,'NumberTitle','off');
...
figure("Name",FigId3,'NumberTitle','off');
...
ylabel('Consistent-ranked Pairs (%)');
...
figure("Name",FigId2,'NumberTitle','off');
title("Primary Weights","FontSize",18);
hold on;
