function WeightFitting = FitWeights(cubeRGBs4Fitting,MeanRanking,IndividualRanking,PlotTitle,FigId)
...
if length(size(cubeRGBs4Fitting)) == 3
    if strcmp(PlotTitle,'Test Session')
    WeightHeatMap(['Max-Weighted Map (',PlotTitle,')'],Allweight,WeightList,WeightMat,OptimalWeight_individual,OptimalWeight_mean,RGB_weights_rad,RGB_weights_lum,FigId);
    end
end
end