function WeightTrianglePlot(LuminanceWeight,RadianceWeight,weights,dot_colors,labels,FigTitle, FigId)
...
lum_handle = plot(Luminance_x,Luminance_y,'v', 'MarkerFaceColor', 'k','MarkerEdgeColor', 'k','MarkerSize',16,'LineWidth',0.5);
...
rad_handle = plot(Radiance_x,Radiance_y,'v', 'MarkerFaceColor', [0.5, 0.5, 0.5],'MarkerEdgeColor', [0.5, 0.5, 0.5],'MarkerSize',16,'LineWidth',0.5);
...
%% Add Legend
labels(end+1:end+3,1) =   {'Luminance';'Radiance';'MaxRGB'};
